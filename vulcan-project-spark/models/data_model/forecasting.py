...
@model(
    "s3depot.device_kkamutala.device_issue_forecast",
    columns={
    ...
    depends_on=["s3depot.device_kkamutala.issues", "s3depot.device_kkamutala.devices"],
    cron='@daily',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    SELECT
        ...
        d.is_active,
        d.platform
    FROM s3depot.device_kkamutala.issues i
    LEFT JOIN s3depot.device_kkamutala.devices d
