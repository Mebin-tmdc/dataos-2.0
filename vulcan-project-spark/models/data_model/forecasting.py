...
@model(
    "s3depot.device_sri.device_issue_forecast",
    columns={
    ...
    depends_on=["s3depot.device_sri.issues", "s3depot.device_sri.devices"],
    cron='@daily',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    SELECT
        ...
        d.is_active,
        d.platform
    FROM s3depot.device_sri.issues i
    LEFT JOIN s3depot.device_sri.devices d
