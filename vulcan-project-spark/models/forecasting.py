...
@model(
    "s3depot.device_08.device_issue_forecast",
    columns={
    ...
    depends_on=["s3depot.device_08.issues", "s3depot.device_08.devices"],
    cron='@daily',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    SELECT
        ...
        d.is_active,
        d.platform
    FROM s3depot.device_08.issues i
    LEFT JOIN s3depot.device_08.devices d
